...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(AssetNotDeletedExcetion.class)
	ResponseEntity<Object> assetNotDeleted(Exception ex) {

		return ResponseHandler.generateResponse(HttpStatus.BAD_REQUEST, false, ex.getMessage());
	}

	@ExceptionHandler(EmployeeNotFoundException.class)
	ResponseEntity<Object> employeeNotDeleted(Exception ex) {

		return ResponseHandler.generateResponse(HttpStatus.BAD_REQUEST, false, ex.getMessage());
	}

	@ExceptionHandler(CategoryNotFoundException.class)
	ResponseEntity<Object> categoryNotDeleted(Exception ex) {
